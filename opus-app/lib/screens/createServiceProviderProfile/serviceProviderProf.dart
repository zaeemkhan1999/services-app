...
class ServiceProviderProfileCreate extends StatefulWidget {
  var service_provider;
  ServiceProviderProfileCreate({@required this.service_provider});
  @override
  _ServiceProviderProfileCreateState createState() =>
      _ServiceProviderProfileCreateState();
}

class _ServiceProviderProfileCreateState
    extends State<ServiceProviderProfileCreate> {
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(widget.service_provider["fullName"],
                                          style: TextStyle(
                                              fontSize: 18,
                                              color: Colors.white)),
                                      Text(
